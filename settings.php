 ...
 * for you.
 */
$our_server_protocol = getenv('OUR_SERVER_PROTOCOL');
$our_server_port = getenv('OUR_SERVER_PORT');
$server_name = getenv('SERVER_NAME');
$base_url = "$our_server_protocol://$server_name";

if($our_server_port != "80")
    $base_url .= ":" . $our_server_port;
